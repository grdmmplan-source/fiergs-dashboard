...
// ============================================================
// DADOS REAIS — extraídos de Discagem_Fila.csv (atualizado 11/06/2026)
// ============================================================
const CAMPANHAS = {
  "Fiergs0106": {
  ...
  "MGE_E_4_6_1063": {
    ...
    carteira: "1063",
    periodo: "01/06/2026 a 09/06/2026",
    mailing_carga: 64013,
    mailing_discador: 48141,
    discados_unicos: 1987,
    nao_discados: 35898,
    cobertura_pct: 25.43,
    penetracao_pct: 19.12,
    total_tentativas: 92191,
    atendidos: 50498,
    nao_atendeu: 40754,
    ocupado: 939,
    hit_rate_pct: 54.78,
    interessados: 425,
    contatos_decisor: 816,
    media_tent_empresa: 46.4,
    sem_sucesso: 47662,
    acordos: 0,
    conversao_pct: 0.0,
    por_hora: [
      { hora: "09h", tentativas: 10217, atendidas: 6157, interesse: 60 },
      { hora: "10h", tentativas: 11229, atendidas: 6287, interesse: 58 },
      { hora: "11h", tentativas: 9376,  atendidas: 4965, interesse: 45 },
      { hora: "12h", tentativas: 8319,  atendidas: 3822, interesse: 44 },
      { hora: "13h", tentativas: 8576,  atendidas: 4713, interesse: 38 },
      { hora: "14h", tentativas: 11018, atendidas: 6294, interesse: 46 },
      { hora: "15h", tentativas: 10743, atendidas: 6152, interesse: 45 },
      { hora: "16h", tentativas: 12050, atendidas: 6657, interesse: 62 },
      { hora: "17h", tentativas: 10605, atendidas: 5431, interesse: 27 },
      { hora: "18h", tentativas: 58,    atendidas: 20,   interesse: 0  },
    ],
    status_dist: [
      { name: "Atendido",    value: 50498, cor: "#f97316" },
      { name: "Não Atendeu", value: 40754, cor: "#ef4444" },
      { name: "Ocupado",     value: 939,   cor: "#f59e0b" },
    ],
    tabulacoes: [
      { name: "Ligação caída",      qtd: 527 },
      { name: "Desligou",           qtd: 464 },
      { name: "Interesse",          qtd: 425 },
      { name: "Fora do perfil",     qtd: 403 },
      { name: "Informação",         qtd: 391 },
      { name: "Engano",             qtd: 268 },
      { name: "Ligação muda",       qtd: 157 },
      { name: "Retorno",            qtd: 83  },
      { name: "Não tabulada (CRM)", qtd: 74  },
      { name: "Caixa postal",       qtd: 27  },
      { name: "Não atende",         qtd: 9   },
      { name: "Oportunidade",       qtd: 8   },
    ],
  },
  "MGE_C_4_1063": {
    label: "MGE_C_4_1063 — Ativo",
    carteira: "1063",
    periodo: "09/06/2026 a 11/06/2026",
    mailing_carga: 0,
    mailing_discador: 0,
    discados_unicos: 30047,
    nao_discados: 0,
    cobertura_pct: 0,
    penetracao_pct: 0,
    total_tentativas: 60062,
    atendidos: 31339,
    nao_atendeu: 28201,
    ocupado: 522,
    hit_rate_pct: 52.18,
    interessados: 241,
    contatos_decisor: 496,
    media_tent_empresa: 2.0,
    sem_sucesso: 29089,
    acordos: 0,
    conversao_pct: 0.0,
    por_hora: [
      { hora: "09h", tentativas: 4383,  atendidas: 2274, interesse: 15 },
      { hora: "10h", tentativas: 5433,  atendidas: 2835, interesse: 24 },
      { hora: "11h", tentativas: 7758,  atendidas: 4122, interesse: 33 },
      { hora: "12h", tentativas: 6189,  atendidas: 2763, interesse: 15 },
      { hora: "13h", tentativas: 4255,  atendidas: 2285, interesse: 9  },
      { hora: "14h", tentativas: 7874,  atendidas: 4158, interesse: 22 },
      { hora: "15h", tentativas: 8944,  atendidas: 4794, interesse: 70 },
      { hora: "16h", tentativas: 9470,  atendidas: 5144, interesse: 40 },
      { hora: "17h", tentativas: 5731,  atendidas: 2951, interesse: 13 },
      { hora: "18h", tentativas: 25,    atendidas: 13,   interesse: 0  },
    ],
    status_dist: [
      { name: "Atendido",    value: 31339, cor: "#f97316" },
      { name: "Não Atendeu", value: 28201, cor: "#ef4444" },
      { name: "Ocupado",     value: 522,   cor: "#f59e0b" },
    ],
    tabulacoes: [
      { name: "Ligação caída",      qtd: 521 },
      { name: "Fora do perfil",     qtd: 448 },
      { name: "Desligou",           qtd: 331 },
      { name: "Informação",         qtd: 255 },
      { name: "Interesse",          qtd: 241 },
      { name: "Engano",             qtd: 210 },
      { name: "Retorno",            qtd: 107 },
      { name: "Ligação muda",       qtd: 97  },
      { name: "Caixa postal",       qtd: 15  },
      { name: "Não atende",         qtd: 12  },
      { name: "Oportunidade",       qtd: 9   },
      { name: "Não tabulada (CRM)", qtd: 4   },
    ],
  },
};
